...
const skillsData = [
  {
    category: "UI/UX",
    icon: <FaPaintBrush className="text-3xl mb-4 text-[#A2D729]" />,
    skills: [
      { name: "Figma", level: 90 },
  ...
  {
    category: "Frontend",
    icon: <FaCode className="text-3xl mb-4 text-[#A2D729]" />,
    skills: [
      { name: "React", level: 95 },
      ...
      <div className="max-w-[1197px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {skillsData.map((category, index) => (
            <div
              key={index}
              className="bg-white p-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-transform duration-300"
            >
                  ...
                  {category.skills.map((skill, idx) => (
                    <div key={idx}>
                      ...
                      <div className="w-full bg-gray-300 rounded-full h-3">
                        <div
                          className="bg-[#A2D729] h-3 rounded-full transition-all duration-1000 ease-out"
